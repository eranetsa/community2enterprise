...
class HrPayslip(models.Model):
    ...
    def refund_sheet(self):
        ...
        form_view_ref = self.env.ref('hr_payroll.view_hr_payslip_form', False)
        tree_view_ref = self.env.ref('hr_payroll.view_hr_payslip_tree', False)
        return {
    ...
    def action_send_email(self):
        ...
        try:
            template_id = self.env.ref('hr_payroll.mail_template_payslip').id
        except ValueError:
            template_id = False
        try:
